 ...
 * @since 1.0.0
 */
class Kuorinka_Plus_Logo_Image_Control extends WP_Customize_Control {

	public function __construct( $wp_customize, $control_id, $args = array() ) {

		// declare these first so they can be overridden
		$this->l10n = array(
			'upload'      => __( 'Add logo', 'kuorinka-plus' ),
			'set'         => __( 'Set as logo', 'kuorinka-plus' ),
			'choose'      => __( 'Choose logo', 'kuorinka-plus' ),
			'change'      => __( 'Change logo', 'kuorinka-plus'),
			'remove'      => __( 'Remove logo', 'kuorinka-plus' ),
			'placeholder' => __( 'No logo set', 'kuorinka-plus' ),
		);
